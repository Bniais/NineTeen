...
void view(SDL_Renderer * renderer, TTF_Font *myFont, TTF_Font *grand, int upscale, struct Environement environement[] ,int score,int animate_perso,int animate_sol,SDL_Texture *texture_background, SDL_Texture *texture_pipes, SDL_Texture *texture_birds, SDL_Texture *texture_medals, SDL_Texture *texture_scoreBoard, SDL_Texture *texture_sol){
	...
	score_print(renderer,grand,score, BLACK, 3);
...
int flappy_bird(SDL_Window *window, SDL_Renderer *renderer, int upscale){
	...
	TTF_Font *grand = TTF_OpenFont("Textures/grand.ttf",100);
	if(!myFont){
		printf("Error\n" );
	}
	...
	while(!end){
		...
		view(renderer,myFont, grand, upscale,environement, score ,animate_perso++ , animate_sol++  ,texture_background,
																																									 texture_pipes,
																																									 texture_birds,
																																									 texture_medals,
																																									 texture_scoreBoard,
