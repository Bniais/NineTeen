...
void init_texture(SDL_Renderer *renderer ,SDL_Texture *texture_background, SDL_Texture *texture_pipes, SDL_Texture *texture_medals, SDL_Texture *texture_scoreBoard, SDL_Texture *texture_sol){
	...
	texture_pipes = LoadTextureWithErrorCode(renderer,DIR_BIRDS);
...
void view(SDL_Renderer * renderer,int animate){
