...
#define UPPER_STEP 30
#define UPPER_SPEED 5
#define UPPER_BY_STEP 10
...
void personnage(SDL_Renderer *renderer,SDL_Texture *texture_birds, SDL_Point coordonner_perso,int upscale, int animate_perso, double angle){
	...
	SDL_RenderCopyEx(renderer,texture_birds,&personnage,&target,angle,&center,SDL_FLIP_NONE);
}
...
void view(SDL_Renderer * renderer, TTF_Font *myFont, SDL_Point coordonner_perso, double angle,int upscale, struct Environement environement[] ,int score,int animate_perso,int animate_sol,SDL_Texture *texture_background, SDL_Texture *texture_pipes, SDL_Texture *texture_birds, SDL_Texture *texture_medals, SDL_Texture *texture_scoreBoard, SDL_Texture *texture_sol){
	...
	personnage(renderer , texture_birds, coordonner_perso , upscale , animate_perso , angle);
...
int flappy_bird(SDL_Window *window, SDL_Renderer *renderer, int upscale){
	...
	while(!end){
		...
		if (upper){
			coordonner_perso.y -= UPPER_BY_STEP ;
			upper -= -gravity_speed + UPPER_SPEED;
		...
		view(renderer,myFont, coordonner_perso , angle ,upscale, environement, score ,animate_perso++ , animate_sol++  ,texture_background,
																																									 texture_pipes,
																																									 texture_birds,
																																									 texture_medals,
																																									 texture_scoreBoard,
	...
	while ( coordonner_perso.y < WINDOW_H - DIM_SOL.y*upscale )
	{
		...
		view(renderer,myFont, coordonner_perso , angle , upscale, environement, score ,0 , 0  ,texture_background,
																																									 texture_pipes,
																																									 texture_birds,
																																									 texture_medals,
																																									 texture_scoreBoard,
