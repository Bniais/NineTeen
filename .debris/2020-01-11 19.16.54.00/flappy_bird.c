...
int AfficherPersonnage(SDL_Renderer *renderer,SDL_Texture *texture_birds, SDL_Point coordonner_perso, int animate_perso, double angle)
{
...
int afficherTout(SDL_Renderer * renderer, SDL_Point coordonner_perso, pilonne *pilonne ,int score,int animate_perso,int animate_sol, int cible, double angle ,SDL_Texture *texture_background, SDL_Texture *texture_pipes, SDL_Texture *texture_birds, SDL_Texture *texture_medals, SDL_Texture *texture_scoreBoard, SDL_Texture *texture_sol, SDL_Texture *texture_chiffre, SDL_Texture* texture_highscore)
{
	...
	if ( AfficherPersonnage(renderer , texture_birds, coordonner_perso  , animate_perso , angle) )
...
int flappy_bird(SDL_Window *window, SDL_Renderer *renderer, int highscore)
{
	...
	if (!exit_code)
	{
		...
		// afficher la vue //
		exit_code = afficherTout(renderer, coordonner_perso , pilonne, score ,1 , 0, cible, angle ,texture_background, 
																		   				   texture_pipes, 
																		   				   texture_birds, 
																		  				   texture_medals,  
																		  				   texture_scoreBoard, 
		...
		while(!end && !exit_code){
				...
				if(!dead){
					...
					exit_code = afficherTout(renderer, coordonner_perso , pilonne, score ,animate_perso++ , animate_sol, cible, angle ,texture_background,
																														   texture_pipes, 
																														   texture_birds, 
																														   texture_medals,  
																														   texture_scoreBoard, 
