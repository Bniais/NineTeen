...
#define NB_SHOOTER_TEXTURES 15
typedef enum{SH_SHIP, SH_FLAME, SH_WEAPON, SH_MISSILE,SH_BACKGROUND, SH_EXPLO_MISSILE, SH_EXPLO_SHIP,SH_LASER_BEAM, SH_ENEMY_ROND, SH_ENEMY_LASER, SH_ENEMY_BOSS, SH_ARM, SH_ARM_BOSS, SH_WARNING, SH_BOSS_BAR}SH_TEXTURES;
