...
#define NB_ASTEROID_TEXTURES 20
typedef enum{A_ARROW, A_VAISS, A_GEM, A_THRUST, A_BACKGROUND, A_HUD, A_ASTEROID, A_FISSURE, A_GLACE, A_BONUS, A_BULLET, A_LASER, A_ROUE, A_JAUGE, A_BOMB, A_BOMB_ICON,A_LOADING, A_EXPLO_MISSILE, A_EXPLO_ASTEROID, A_EXPLO_GLACE}A_TEXTURES;
...
#define NB_SHOOTER_TEXTURES 10
typedef enum{SH_SHIP, SH_FLAME, SH_WEAPON, SH_MISSILE,SH_BACKGROUND, SH_EXPLO_MISSILE, SH_EXPLO_SHIP, SH_ENEMY_ROND, SH_ENEMY_LASER, SH_ENEMY_BOSS}SH_TEXTURES;
