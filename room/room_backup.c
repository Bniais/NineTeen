...
void initialisation_salon(int salon){
	//Mettre les murs
...
void animate_texture(SDL_Texture* Texture, int frame, int totAnim){

		case 0: load_texture_png_(renderer,"assets/texture/personnage_1_b.png",temp) ;break;
		case 1: load_texture_png_(renderer,"assets/texture/personnage_2_b.png",temp);break;
		case 2: load_texture_png_(renderer,"assets/texture/personnage_3_b.png",temp);break;
		case 3: load_texture_png_(renderer,"assets/texture/personnage_4_b.png",temp) ;break;
		case 4: load_texture_png_(renderer,"assets/texture/personnage_b.png",temp) ;break;
