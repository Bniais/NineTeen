...
if(MSVC)
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    ...
    set(importLibraryName "assimp${ASSIMP_LIBRARY_SUFFIX}.dll.a")
    ...
    set(staticLibraryName "assimp${ASSIMP_LIBRARY_SUFFIX}.a")
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    ...
    set(staticLibraryName "libassimp${ASSIMP_LIBRARY_SUFFIX}.a")
    set_target_properties(assimp::assimp PROPERTIES
      IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/${staticLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
...
get_filename_component(ASSIMP_ROOT_DIR "/mingw64" REALPATH)
