...
//Missile
	...
	typedef struct Missile_s{float x; float y; int id; float rota; float damage; float speed;}Missile;
	const Ellips MISSILE_HITBOX[NB_ALLY_MISSILES + NB_ENEMY_MISSILES] = {
		{0,0,6*RATIO_SIZE_MISSILE[0], 16*RATIO_SIZE_MISSILE[0]},
		{0,0,6*RATIO_SIZE_MISSILE[1] ,16*RATIO_SIZE_MISSILE[1]},
		{0,0,6*RATIO_SIZE_MISSILE[2], 16*RATIO_SIZE_MISSILE[2]},
		{0,0,12.5*RATIO_SIZE_MISSILE[3], 12.5*RATIO_SIZE_MISSILE[3]},
		{0,0,6*RATIO_SIZE_MISSILE[4], 16*RATIO_SIZE_MISSILE[4]}
	};
	...
	const SDL_Point MISSILE_CENTER[NB_ALLY_MISSILES + NB_ENEMY_MISSILES] = {
		{19*RATIO_SIZE_MISSILE[0],26*RATIO_SIZE_MISSILE[0]},
		{19*RATIO_SIZE_MISSILE[1],26*RATIO_SIZE_MISSILE[1]},
		{19*RATIO_SIZE_MISSILE[2],26*RATIO_SIZE_MISSILE[2]},
		{29*RATIO_SIZE_MISSILE[3], 30*RATIO_SIZE_MISSILE[3]},
		{19*RATIO_SIZE_MISSILE[4], 26*RATIO_SIZE_MISSILE[4]}
	};
...
//Enemies
	...
	typedef struct {int id; float x; float y; float r; float rota; float hp; int nbWeapon; Weapon weapons[NB_MAX_WEAPON_ENEMY]; int frameHit;}Enemy;
	...
	const Vector2f WEAPON_DEST_ENEMY[NB_ENEMY][NB_MAX_WEAPON_ENEMY] = {
		{{39.5/RATIO_SIZE_ENEMY[0], 77/RATIO_SIZE_ENEMY[0]}},
		{{43.5/RATIO_SIZE_ENEMY[1], 104/RATIO_SIZE_ENEMY[1]}, {52.5/RATIO_SIZE_ENEMY[1], 108/RATIO_SIZE_ENEMY[1]}, {97.5/RATIO_SIZE_ENEMY[1], 108/RATIO_SIZE_ENEMY[1]}, {107/RATIO_SIZE_ENEMY[1], 103/RATIO_SIZE_ENEMY[1]}},
		{{44.5/RATIO_SIZE_ENEMY[2], 137/RATIO_SIZE_ENEMY[2]}, {50.5/RATIO_SIZE_ENEMY[2], 140/RATIO_SIZE_ENEMY[2]}, {57/RATIO_SIZE_ENEMY[2], 142/RATIO_SIZE_ENEMY[2]}, {107/RATIO_SIZE_ENEMY[2], 139/RATIO_SIZE_ENEMY[2]}, {156/RATIO_SIZE_ENEMY[2], 142/RATIO_SIZE_ENEMY[2]}, {162.5/RATIO_SIZE_ENEMY[2], 140/RATIO_SIZE_ENEMY[2]}, {169/RATIO_SIZE_ENEMY[2],137/RATIO_SIZE_ENEMY[2]}}
	};
