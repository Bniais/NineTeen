...
static SDL_Rect FLECHE_DEST[6] = {
    {PLAYGROUND_SIZE_W/2 - 50/2,  PLAYGROUND_SIZE_H/2 - BODY_RADIUS -50 -4,50,30},
    {PLAYGROUND_SIZE_W/2 - 50 -10 - BODY_RADIUS,  PLAYGROUND_SIZE_H/2 -30/2,50,30},
    {PLAYGROUND_SIZE_W/2 + 10 + BODY_RADIUS,  PLAYGROUND_SIZE_H/2- 30/2,50,30},
    {10,720,40,20},
    {26,736,40,20},
    {10,834,56,38}
};
